...
public class MainActivity extends AppCompatActivity {
    ...
    private void performOperation(char operation) {
        ...
        if (num1Str.isEmpty() || num2Str.isEmpty()) {
            Toast.makeText(this, "nu ai introdus ambele numere", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        switch (operation) {
            ...
            case '/':
                if (num2 == 0) {
                    Toast.makeText(this, "nu poti imparti la 0", Toast.LENGTH_SHORT).show();
                    return;
                }
                result = num1 / num2;
                break;
        ...
        tvResult.setText("Rezultat: " + result);
    }
}
